<template>
  ...
  <nav class="navbar  bg-light">
    <div class="container-fluid">
      ...
      <div class="d-flex">
        <router-link :to="`/gift/detail/`"><button class="btn btn-primary " type="submit">Add</button></router-link>
      </div>
    </div>
...
<div class="container text-center">
    <div class="container row-cols-3" style="width: 56rem" v-for="booking in bookings" :key="booking._id">
      <div class="col" style="float: left">
        <div class="row"></div>
      <div class="card">
        <router-link :to="`/gift/detail/${booking._id}`">
        <img src="../assets/image.webp" class="card-img-top"
          alt="Hollywood Sign on The Hill"></router-link>
        <div class="card-body">
          <h5 class="card-title">{{ booking.gifttitle }}</h5>
          <li class="list-group-item">{{ booking.giftdescription }}</li>
